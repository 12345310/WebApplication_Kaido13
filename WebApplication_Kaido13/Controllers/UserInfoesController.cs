...
using WebApplication_Kaido13.Data;
using WebApplication_Kaido13.Models;

namespace WebApplication_Kaido13.Controllers
{
    public class UserInfoesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,OrganizationId")] UserInfo userInfo)
        {
            ...
            ViewData["OrganizationId"] = new SelectList(_context.Organizations, "Id", "Name", userInfo.OrganizationId);
            return View(userInfo);
        }
